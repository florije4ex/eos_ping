...
cleos wallet import --private-key 5KWfNLVokpE22KmP7HTQHW3KfkFUeMabTgnBYMn5J9FrYkcaWqJ
...
cleos create account eosio ping.ctr EOS4ueqBgA4ZpeanDCkBjxWAwKG7CDPwWSnqNE6iNGCgwvgPcM9tf EOS4ueqBgA4ZpeanDCkBjxWAwKG7CDPwWSnqNE6iNGCgwvgPcM9tf
cleos create account eosio tester EOS4ueqBgA4ZpeanDCkBjxWAwKG7CDPwWSnqNE6iNGCgwvgPcM9tf EOS4ueqBgA4ZpeanDCkBjxWAwKG7CDPwWSnqNE6iNGCgwvgPcM9tf
docker exec keosd mkdir /contracts/ping
docker cp ./contract/ping.cpp keosd:/contracts/ping/ping.cpp
eosiocpp -o /contracts/ping/ping.wast /contracts/ping/ping.cpp
eosiocpp -g /contracts/ping/ping.abi /contracts/ping/ping.cpp
cleos set contract ping.ctr /contracts/ping -p ping.ctr
